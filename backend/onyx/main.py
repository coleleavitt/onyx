...
from onyx.server.features.memory.api import router as memory_router
...
from onyx.server.manage.memory_governance import (
    admin_router as memory_governance_admin_router,
)
...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(
        application, memory_governance_admin_router
    )
    ...
    include_router_with_global_prefix_prepended(application, memory_router)
