...
class Artifact(Base):
    """An immutable, object-store-backed version of a library artifact."""
    ...
    library_item_id: Mapped[UUID | None] = mapped_column(
        PGUUID(as_uuid=True),
    ...
    storage_file_id: Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    library_item: Mapped["ArtifactLibraryItem | None"] = relationship(
        "ArtifactLibraryItem", back_populates="versions"
    )
...
class ArtifactLibraryItem__User(Base):
    __tablename__ = "artifact_library_item__user"
    ...
    __table_args__ = (Index("ix_artifact_library_item__user_user_id", "user_id"),)


class ArtifactLibraryItem__UserGroup(Base):
    __tablename__ = "artifact_library_item__user_group"
...
class ArtifactLibraryItem(Base):
    ...
    __tablename__ = "artifact_library_item"
    ...
    user_shares: Mapped[list[ArtifactLibraryItem__User]] = relationship(
        ArtifactLibraryItem__User,
        cascade="all, delete-orphan",
        lazy="selectin",
    )
    ...
    __table_args__ = (
        ...
        Index("ix_artifact_library_item_published", "published_at"),
    )
